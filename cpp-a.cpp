...
int main()
{
    cout << "Welcome to demonstrate of different data types!" << endl
         << endl;
    int number1 = 400;
    ...
    cout << "The size of unsigned short int data type " << number3 << " is " << sizeof(number3) << " bytes" << endl;
    ...
    cout << "The size of unsigned long long int data type " << number6 << " is " << sizeof(number6) << " bytes" << endl;
    ...
    cout << "The size of bool data type " << flag << " is " << sizeof(flag) << " bytes" << endl;
    return 0;
}